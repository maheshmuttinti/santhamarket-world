...
function App() {
  return (
    <div style={{ padding: "20px", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <p>
        Your privacy is important to us. It is Santha Market&apos;s policy to
        respect your privacy regarding any information we may collect from you
        across our website,{" "}
        <a href="https://santhamarket-world.maheshmuttintidev.in">
          https://santhamarket-world.maheshmuttintidev.in
        </a>
      ...
      <p>This policy is effective as of 2024.</p>
    </div>
  );
}
